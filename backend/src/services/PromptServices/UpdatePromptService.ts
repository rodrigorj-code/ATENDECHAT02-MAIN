...
const UpdatePromptService = async ({
    ...
    const { name, apiKey, prompt, model, maxTokens, temperature, promptTokens, completionTokens, totalTokens, queueId, maxMessages, voice, voiceKey, voiceRegion } = promptData;
    ...
    await promptTable.update({ name, apiKey, prompt, model, maxTokens, temperature, promptTokens, completionTokens, totalTokens, queueId, maxMessages, voice, voiceKey, voiceRegion });
